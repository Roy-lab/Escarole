...
/**
* Reads a tab-delimited data file.
* Reads columns as variables and rows as samples.
* Sample names get stored in sampleNames.
*/
Error::ErrorCode
	...
	while(evidStr[currInd]!='\0')
	{
		  ...
		  )
		{
			...
			else
			{
				...
				if(pos==NULL)
				{
					double varVal=log(atof(tempTok))/log(2.0);
